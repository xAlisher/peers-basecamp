...
cd "$(dirname "$0")/.."
rc=0
for t in tests/backup.mjs tests/hosted-media.mjs tests/ui-tour.mjs tests/exchange.mjs tests/group.mjs tests/interactions.mjs tests/media.mjs tests/voice.mjs; do
  echo "═══════════════════════════════════════ $t"
