#!/usr/bin/env python3
"""Validate a staged peers_core package, then atomically install it."""
...
from validate_core_package import validate
...
def main() -> int:
    ...
    try:
        ...
        print(f"core installation failed: {exc}", file=sys.stderr)
        return 1
    return 0
